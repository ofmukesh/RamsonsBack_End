...
class Permission_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','user','admin', 'register_user', 'modify_permission', 'dashboard', 'company', 'inward_form', 'vehicle_entry', 'mother_table', 'slitted_table', 'pipe_inward', 'planning', 'coil_planning', 'slitt_plan', 'pc_pipe', 'download',
